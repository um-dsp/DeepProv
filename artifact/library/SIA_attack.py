...
class MIFGSM(Attack):
    ...
    def __init__(self, model, epsilon=0.3, alpha=0.03, epoch=10, decay=1., targeted=False, random_start=False, 
...
class SIA(MIFGSM):
    ...
    def __init__(self, model,  epsilon=0.3, alpha=0.03, epoch=10, decay=1., num_copies=20, num_block=3, targeted=False, random_start=False, 
